...
def _get_tp_fp_fn_extern(predictionlist, groundtruthlist, totalperformance, 
                         confidencethresh=0.3,IOUthresh=0.5):
    """
...
if __name__=='__main__':
    ...
    parser.add_argument('--file_path', type=str, 
                        default='D:/Private Manager/Personal File/uOttawa/Lab works/2018 fall/BerkleyDeepDrive/bdd100k/detection results/ssd_mobilenet_v2_300_bdd/', 
                        help="File path of input data, also the path to save figures")
    parser.add_argument('--model_name',type=str,default='original ssd 300',
                        help='model name for charts')
    parser.add_argument('--detected_path',type=str, 
                        default='D:/Private Manager/Personal File/uOttawa/Lab works/2018 fall/BerkleyDeepDrive/bdd100k/detection results/ssd_mobilenet_v2_300_bdd/annotation_val_detection.json',
